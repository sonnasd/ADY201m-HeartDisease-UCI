...
def main() -> None:
    required_files = [
        ...
        REPORT_DIR / "raw_table_shape_report.csv",
        ...
        SQL_DIR / "03_import_data.sql",
        SQL_DIR / "04_data_quality_checks.sql",
        SQL_DIR / "05_analysis_queries.sql",
        SQL_DIR / "06_create_ml_view.sql",
    ...
    for name in RELATIONAL_TABLES:
        assert_exists(RELATIONAL_DIR / f"{name}.csv")
